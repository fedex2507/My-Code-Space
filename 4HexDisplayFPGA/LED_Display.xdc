## This file is a general .xdc for the Basys3 rev B boar
...
## 4-bit inputs
set_property PACKAGE_PIN V17 [get_ports input0[0]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input0[0]]
set_property PACKAGE_PIN V16 [get_ports input0[1]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input0[1]]
set_property PACKAGE_PIN W16 [get_ports input0[2]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input0[2]]
set_property PACKAGE_PIN W17 [get_ports input0[3]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input0[3]]

set_property PACKAGE_PIN W15 [get_ports input1[0]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input1[0]]
set_property PACKAGE_PIN V15 [get_ports input1[1]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input1[1]]
set_property PACKAGE_PIN W14 [get_ports input1[2]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input1[2]]
set_property PACKAGE_PIN W13 [get_ports input1[3]]                                       
...
set_property PACKAGE_PIN W2 [get_ports input3[0]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input3[0]]
set_property PACKAGE_PIN U1 [get_ports input3[1]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input3[1]]
set_property PACKAGE_PIN T1 [get_ports input3[2]]                                       
set_property IOSTANDARD LVCMOS33 [get_ports input3[2]]
set_property PACKAGE_PIN R2 [get_ports input3[3]]                                       
